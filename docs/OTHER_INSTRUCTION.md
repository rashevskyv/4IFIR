...
**emuMMC**  
**Nindendo**  
7. Скопировать содержимое архива  [4IFIR.ZIP](https://sintez.io/4IFIR.zip) (не сам архив, а файлы и папки находящиеся в нём) в корень SD карты.
8. Сделать безопасное извлечение SD карты на ПК.
9. На Switch нажать Close.
10. Отсоединить провод. 
11. На Nindendo Switch нажать Close>Home>Reboot>Normal.
...
**emuMMC**  
**Nindendo**  
5. Скопировать содержимое архива [4IFIR.ZIP](https://sintez.io/4IFIR.zip)(не сам архив, а файлы и папки находящиеся в нём) в корень SD карты.
6. Сделать безопасное извлечение SD карты на ПК.
7. Извлечь картридер из ПК, извлечь SD карту из картридера и вставить SD карту в консоль.
8. Включить консоль

### 2. Скачивание прошивки 18.1.0
1. Запустите консоль в SEMI-STOCK **Hekate** > **Launch** > **Semi-stock**
1. Запустите [**Homebrew Launcher**](https://switch.customfw.xyz/hbl) > **All in One Updater**
