...
1. Черный экран после лого Nintendo:  
   >попробуйте выполнить - [Отладочную установку](INSTAL_4IFIR.md#отладочная-установка-рекомендуемый-метод-тк-позволяет-избежать-большинства-проблем-при-переходе-с-других-проектов-из-за-конфликта-компонентов)  
