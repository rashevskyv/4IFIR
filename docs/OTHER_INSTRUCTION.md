...
****
>**ВАЖНО: Если у вас установлен FIX 4EKATE (через AIO или архив 4IFIX.zip из Телеграм группы, то следует выполнить - [Отладочную установку](INSTAL_4IFIR.md#отладочная-установка-требуется-пк)  
