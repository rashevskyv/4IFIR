...
1. Удалите с карты памяти всё, кроме папок Nintendo и emummc (если есть)
  * Карта должна быть в [FAT32](http://format.customfw.xyz)
...
Моды для улучшения картинки нужно искать [на 4PDA](https://4pda.to/forum/index.php?act=findpost&pid=81825647&anchor=Spoil-81825647-8).
...
Не стесняйтесь играть с частотами и использовать монитор FPS для достижения наилучшего стабильного результата!

В общих чертах:
Есть такой оверлей для теслы, называется InfoNX, он показывает энергопотребление CPU, GPU, RAM в милливольтах (mV).
Засеките сколько сейчас у вас там потребляется.

Когда будет консоль на марико, установите на неё чифир 1.2.

1. Поверх чифира установите Stage начиная с первого.
2. В sys-clk повышайте частоты до тех пор, пока потребление CPU, GPU, RAM в InfoNX будет ниже, чем на эристе.
3. Проверьте стабильность в играх. 
4. Если вы не зафиксируете никаких вылетов, артефактов и прочих аномалий, то повышайте стейдж и снова повторяйте процесс начиная со 2го пункта. А если зафиксировали аномалии, то откатите на 1 стейдж назад так, как это будет значить, что прошлый стейдж - это ваш предел
...
Как использование кефира влияет на срок службы батареи 
Моя батарея деградировала 
Свитч выключается при использовании разгона 
Свитч разряжается до 1% со 100 за 10 минут 
Нет говернора 
Частоты прыгают 


Аккумулятор не деградирует от силы тока, а только при достижении определенной температуры, что активирует защиту, основанную на законах физики, и разрывает цепь питания, чтобы предотвратить деградацию химических свойств ячеек.

В этом тексте рассказывается о том, как нагрузка свыше 15 ватт может привести к снижению оценки остаточной ёмкости аккумулятора в консоли Nintendo Switch. Контроллер питания консоли сравнивает фактические показания с показаниями, которые были вбиты с завода, и в случае превышения дергает аварийное отключение. Консоль может считать, что аккумулятор не вывез, и снизить оценку его остаточной ёмкости, на 1% при каждом сбое. Это может привести к тому, что индикатор заряда консоли начинает мгновенно опускаться до 1% заряда, когда дается нагрузка на аккумулятор. Battery Fix, украденный у CtCaer-а, может позволить "регенерировать" списанную по ошибке ёмкость аккумулятора.

Главное из этого текста:

    Консоль Nintendo Switch имеет защиту от опасных значений тока.
    Значения лимитов тока для разных моделей консоли указаны в спецификациях производителя.
    Мощность (в ваттах) можно рассчитать как произведение напряжения на ток, а ток - как отношение мощности к напряжению.
...
Этот текст описывает удивительное улучшение производительности стабильной системы, которое автор наблюдал своими глазами. Игры, которые раньше казались тормозящими и неотзывчивыми на этой платформе, теперь невероятно быстрые и плавные благодаря улучшенной скорости памяти, пропускной способности и таймингам. Даже при более низких частотах ЦП и ГП, система обеспечивает более отзывчивую и плавную частоту кадров, устраняя заикание и упавшие кадры. Автор не в состоянии полностью передать опыт только словами и призывает читателей попробовать это на себе. Китайский планшет вновь удивил автора, несмотря на его первоначальный скептицизм.


Governor - рекомендуется держать включенным. С его помощью консоль сама решает когда ей повышать частоты, а когда понижать, тем самым заметно экономля заряд батарей.-->