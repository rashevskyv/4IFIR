...
Внутри меню **SmartMode**  находятся три основных раздела: 
...
Внутри меню **4Advanced**  находятся разделы: 
* **CPU** - настройка процессора.
